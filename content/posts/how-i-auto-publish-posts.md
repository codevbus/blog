...
## Generate A Build Hook {#generate-a-build-hook}

The first thing I did was generate a unique build hook in my "Site Settings" in the Netlify admin UI:

{{< figure src="/ox-hugo/netlify_settings.png" >}}

...went to "Build & deploy":

{{< figure src="/ox-hugo/netlify_build_and_deploy.png" >}}

...and finally added a "Build hook":

{{< figure src="/ox-hugo/netlify_build_hooks.png" >}}
...
## Automatically Trigger The Build Hook With Github Actions {#automatically-trigger-the-build-hook-with-github-actions}
...
## Define a Github Secret {#define-a-github-secret}

First, I go to repo "Settings":

{{< figure src="/ox-hugo/github_settings.png" >}}
